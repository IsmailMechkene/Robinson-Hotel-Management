...
public class ReservationsManagementController implements Initializable {
    ...
    private void saveReservationToDatabase(String checkIn, String checkOut, String cin, String roomId) {
        ...
        try {
            ...
            if (resultSet.next()) {
                AddMessageLabel.setText("Conflict: Room is already reserved in that time period.");
            } else {
    ...
    private void modifyReservationInDatabase(String reservationId, String checkIn, String checkOut, String cin, String roomId) {
        ...
        String updateQuery = "UPDATE reservation SET date_fin = '" + checkOut + "', date_deb = '" + checkIn + "', CIN ='" + cin + "', idchambre = '" + roomId +
    ...
    private void deleteReservationFromDatabase(String reservationId) {
        ...
        String deleteQuery = "DELETE FROM reservation WHERE idreservation = '" + reservationId + "'";
